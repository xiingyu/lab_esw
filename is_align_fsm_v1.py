## 아직~~~~~ 여기에 합치려고 노력중,, update :: 24.08.14
...
class is_alignment_fsm:
    def __init__(self, actual_diameter_meters=0.04267, focal_length=403, neck_angle=60): # focal_length는 라파카메라 기준으로 다시 해야함
        ...
        self.preprocess_image = preprocess_img(self.camera)
        self.pixel_distance = RedBallDetector(self.camera)
        

cap = cv2.VideoCapture('./alignment_case1.mov')

# [영상처리] 9분할 화면 중 가운데에 있는지 확인 및 픽셀 거리 측정
    #def is_9_n_pixel_dist(self, )
# [제어] 왼쪽 게걸음 1step
