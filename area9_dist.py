...
area_threshold = 4000  # 발끝에 있는지 확인하기 위한 임계 영역 크기 (픽셀 단위)
...
def detect_and_calculate_distance(frame):
    ...
    if contours:
        ...
        if pixel_area == 0:
            return frame, None, None, None, None, case_number, False
        ...
        # case 8인지 확인
        is_case_8 = case_number == 8
        return frame, distance, center, pixel_area, walk_dist, case_number, is_case_8

    return frame, None, None, None, None, None, False
...
while True:
    ...
    frame, distance, center, pixel_area, walk_dist, case_number, is_case_8 = detect_and_calculate_distance(frame)
    if distance:
        ...
        if is_case_8 and pixel_area >= area_threshold:
            cv2.putText(frame, "Turn now", (10, 150), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
